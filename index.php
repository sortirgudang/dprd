...
<html lang="en">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="alert alert-danger alert-dismissible">
                                ...
                                <strong>Perhatikan!</strong> Stock <?=$barang;?> Telah Habis
                            </div>
                            <?php
                                }
                            ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <button type="sumbit" class="btn btn-primary" name="updatebarang">Submit</button>
                                                </div>
                                                </form>
    ...
    <div class="modal-dialog">
        ...
        <br>
        <button type="sumbit" class="btn btn-primary" name="addnewbarang">Submit</button>
        </div>
        </form>
